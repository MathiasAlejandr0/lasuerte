...
export function Footer() {
  return (
    <footer className="border-t border-white/5 py-12 px-4 bg-brand-bgLight/40 backdrop-blur-md relative mt-auto">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-brand-muted">
        <div className="space-y-4">
          ...
          <p className="text-xs text-brand-muted leading-relaxed opacity-80">
            ...
            participar de forma 100% transparente en el sorteo de vehículos
            deportivos cero kilómetros.
          </p>
        </div>
